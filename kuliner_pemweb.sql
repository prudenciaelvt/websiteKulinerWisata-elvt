...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2024 at 05:13 PM
...
INSERT INTO `resep` (`id`, `nama`, `url_foto`, `deskripsi`, `cara_membuat`, `url_video`) VALUES
(1, 'Soto Lamongan', 'uploads\\sotolmg.jpg', 'Kuliner satu ini sudah familier di telinga wisatawan atau pecinta makanan. Dalam seporsi soto Lamongan terdapat daging ayam yang di suwir-suwir, mie bihun, irisan tomat, daun kol yang dipotong kecil-kecil, telur ayam, jeruk nipis, kerupuk udang, hingga sambal.', 'Bumbu yang dihaluskan:\n- 8 butir kemiri disangrai\n- 1 sdm lada butiran disangrai\n- 2 sdm ketumbar butiran disangrai\n- 1 sdt jinten disangrai\n- 9 siung bawang putih\n- 15 siung bawang merah\n- 9 cm jahe\n- 15 cm kunyit\n- Sedikit air\n- 3 batang sereh\n- 7 cm lengkuas\n- 10 lembar daun jeruk\n- Minyak goreng secukupnya untuk menumis bumbu\n- 350 gram bandeng utuh, digoreng, ambil dagingnya lalu dihaluskan.\n- 1,8 kg ayam kampung\n- 6 liter air (jumlah air sesuaikan dengan ukuran ayam)\n- 1 sdm garam (penggunaan garam, gula, dan penyedap disesuaikan dengan jumlah kuah soto)\n- 1 sdm gula pasir\n- 1 sdt kaldu ayam bubuk\n- Daun bawang secukupnya\n\nBahan-bahan sate jeroan:\n- 2 pasang rempela ati ayam kampung\n- Uritan dan telur muda\n\nBahan-bahan koya:\n- 2 genggam bawang putih goreng krispi\n- 1 toples kerupuk udang yang sudah digoreng\n\nBahan-bahan sambal:\n- 130 gram cabe rawit merah\n- 2 siung bawang putih\n- 200 ml air\n- 1 sdt garam\n- 1 sdt gula pasir\n- 1/2 sdt kaldu ayam bubuk\n\nBahan-bahan pelengkap:\n- Seledri\n- Kol/kubis\n- Jeruk nipis\n- Bawang merah goreng\n- Soun diseduh\n- Telur rebus\n- Kecap manis jika suka', 'https://youtube.com/watch?v=afD1GvxI_YE'),
(2, 'Jumbrek', 'uploads\\jumbreklmg.jpg', 'Terbuat dari tepung beras dan dicampur dengan gula jawa, serta santan kelapa. Untuk rasa, jajanan ringan ini mempunyai citarasa yang manis dan lembut. Aromanya harum karena dibalut dengan daun lontar sebagai pembungkusnya.', 'Bahan-bahan:\n125 gram tepung beras\n50 gram tepung sagu\nnangka secukupnya\n300 gram gula merah\n1 liter santan\n0.5 sdt garam\n2 lembar daun pandan\n400 ml air\n14 batang daun kelapa', 'https://youtu.be/3L9yko9Iy9M?si=SxRK9mUOSZB6fijl'),
(3, 'Wingko', 'uploads\\wingkolmg.jpg', 'Wingko berasal dari Babat, sebuah daerah di Lamongan. Jajanan ini terbuat dari tepung ketan, tepung tapioka, kelapa parut, gula, dan santan. Tekstur wingko babat kenyal dan rasanya gurih manis. Sensasi mengunyah wingko babat terasa berbeda berkat kelapa parutnya.', 'Bahan-bahan:\n- 300 gr tepung beras ketan\n- 430 gr kelapa parut\n- ½ sdt garam\n- ½ sdt vanili bubuk\n- 1 lembar daun pandan\n- 220 gr gula\n- 300 ml air kelapa ( boleh sesuai selera)', 'https://youtu.be/Ss4YaOGXZRo?si=DLk9LMsgHohA_SIb'),
(4, 'Nasi Boranan', 'uploads\\borananlmg.jpg', 'Kuliner Lamongan yang juga banyak sekali peminatnya karena rasa yang dimiliki adalah Nasi Boranan. Dalam seporsi terdapat nasi, rempeyek, ikan bandeng, tahu, tempe, daging ayam, dan telur dadar. Hal yang membuat nasi boranan unik adalah sambalnya yang khas.', 'Bahan-bahan:\n- 4 sdm kelapa parut yang muda\n- 2 sdm santan instan\n- 600 ml air\n- 2 cm lengkuas\n- 1 sdt garam\n- 2 sdt gula pasir\n- ½ sdt merica bubuk\n- 1 sdt kaldu jamur\n- 8 batang daun bawang\n- ½ kg ayam yg sudah direbus\n \nBahan Sambal Boranan yang dihaluskan:\n- 8 buah cabe merah besar\n- 50 gr cabe rawit merah\n- 120 gr bawang merah\n- 30 gr bawang putih\n- 5 butir kemiri sangrai', 'https://youtu.be/yF6ps1AVplQ?si=FexJvjOy8KJfdlm8'),
(5, 'Bandeng Colo', 'uploads\\bandengcololmg.jpg', 'Makanan ini cocok bagi pecinta pedas. Sebab, sambal di bandengnya memiliki rasa sangat pedas, kemudian dicampur dengan parutan jeruk nipis. Menu ikan bandeng disajikan dengan sayuran dan kuah sup yang berwarna kuning.', 'Bahan-bahan:\n- Ikan bandeng\n- lengkuas\n- Asam jawa\n- Kunyit\n- Bawang merah\n- Bawang putih\n- Kemiri\n- Ketumbar\n- Daun jeruk\n- Daun bawang\n- cabe rawit', 'https://youtu.be/BelD2gbXoMM?si=NErjpvWG1iLGxXqo'),
(6, 'Tahu Campur', 'uploads\\tahucampurlmg.jpg', 'Kuah petis udang, ciri khas tahu campur lamongan yang membuat sajian ini makin nikmat. Dalam satu piring tahu campur lamongan biasanya terdiri dari tahu, lontong, perkedel ketela pohon, bihun, dan daging sapi. Disajikan bersama daun selada dan taoge. Baru disiram kuah petis udang.', 'Bahan bahan:\n- 500 gr daging tetelan sapi\n- 2 batang Serai\n- 4 lembar daun jeruk\n- 1 jempol lengkuas\n- 2 lembar daun salam\n\nBumbu halus:\n- 10 siung bawang putih\n- 7 siung bawang merah\n- 1 ruas kunyit\n- 2 cm kencur\n- 2 cm jahe\n- 1/2 sdm ketumbar\n- 1 sdt merica\n- 1/4 sdt jintan\n- 2 sdm petis udang / petis hitam\n\nBumbu petis:\n- 80 gr petis udang\n- 2 sdm bawang putih goreng\n- 200 ml air\n- 1 sdt gula pasir\n\nBahan pelengkap:\n- Perkedel singkong\n- tauge/kecambah rebus\n- daun selada \n- mie rebus\n- tahu goreng\n- kerupuk\n\nSambal :\n- 25 biji cabai rawit rebus\n- 1 sdt garam', 'https://youtu.be/Np0492WNGvY?si=wvEB-CYonj9V_O6G'),
(7, 'Dawet Siwalan', 'uploads\\dawetsiwalanlmg.jpg', 'Siwalan, buah khas dari Lamongan yang sejenis pohon palem. Biasanya disebut juga pohon lontar. Dalam satu gelas es dawet terdiri dari buah siwalan yang sudah dimasak dan dipotong serta kuah santan dan gula merah dari siwalan.', 'Bahan :\n- 5 buah Siwalan\n- 1 lt air santan\n- 200 gram gula merah\n- 200 gram gula pasir\n- 3 lembar daun pandan\n- 1 sdm garam\n- es batu secukupnya', 'https://youtu.be/W9U5WlJ9LX4?si=lttK12MRE3stToyk');
...
--
ALTER TABLE `resep_bahan`
  ADD CONSTRAINT `resep_bahan_ibfk_1` FOREIGN KEY (`resep_id`) REFERENCES `resep` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `resep_bahan_ibfk_2` FOREIGN KEY (`bahan_id`) REFERENCES `bahan` (`id`) ON DELETE CASCADE;
COMMIT;
